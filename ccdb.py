...
CCATDB = [
    ...
    {'twitter': 'artiscoffee', 'ig': u'@artiscoffee'},
    ...
    {'twitter': 'Perkkafe', 'ig': u'@perkkafenyc'},
    {'twitter': 'SouthsideCoffee', 'ig': u'@southside_coffee'},
    {'twitter': 'cafegrumpy', 'ig': u'@cafegrumpy'},
    {'twitter': 'Cento330', 'ig': u'@centocoffeesf'},
    {'twitter': 'StatesCoffee', 'ig': u'@statescoffee'},
    ...
    {'twitter': '#CoffeeBar Redding', 'ig': u'@coffeebarredding'},
    {'twitter': 'BlackEyeCoffee', 'ig': u'@blackeyecoffee'},
    {'twitter': 'CaseCoffee', 'ig': u'@case_coffee_roasters'},
    {'twitter': 'yardstickcoffee', 'ig': u'@yardstickcoffee'},
    {'twitter': 'wgcoffee', 'ig': u'@wanderinggoatcoffee'},
    {'twitter': 'lusso_lab', 'ig': u'@lussolab_samchung'},
    {'twitter': 'threewilliamsau', 'ig': u'@threewilliamscafe'},
    {'twitter': '_saintsimon_', 'ig': u'@saintsimoncoffee'},
    {'twitter': 'vervecoffee', 'ig': u'@vervecoffee'},
    {'twitter': 'abbott_st', 'ig': u'@abbottstespresso'},
    {'twitter': 'blacktoastcafe', 'ig': u'@blacktoastcafe'},
    {'twitter': 'pabloandrustys', 'ig': u'@pabloandrustys'},
    {'twitter': '7seedscoffee', 'ig': u'@7seedscoffee'},
    {'twitter': 'lilmcoffee', 'ig': u'@thelittlemarionette'},
    {'twitter': 'porchandparlour', 'ig': u'@porchandparlour'},
    {'twitter': 'Intelligentsia', 'ig': u'@intelligentsiacoffee'},
    {'twitter': 'GandBcoffee', 'ig': u'@gandbcoffee'},
    {'twitter': 'TheFRENCHPRESS', 'ig': u'@thefrenchpress'},
    ...
    {'twitter': 'calipressjuice', 'ig': u'@calipressjuice'},
    {'twitter': 'chansbros', 'ig': u'@chansbros'},
    {'twitter': 'terarosacoffee', 'ig': u'@terarosacoffee'},
    {'twitter': 'herkimercoffee', 'ig': u'@herkimercoffee'},
    {'twitter': 'habitualph', 'ig': u'@habitualcoffee'},

    # No twitter handle
    {'text': 'The Ritchfield', 'ig': u'@therichfield'},
    ...
    {'text': '#TroubleCoffee', 'ig': u'@troublecoffeeco'},
    {'text': '#revolverbali', 'ig': u'@revolverespresso'},
    {'text': '#fiftyfiftysf', 'ig': u'@fiftyfiftysf'},
    {'text': '#BrewCoffeeandBeer', 'ig': u'@brew_coffeeandbeer'},
    {'text': '#vertigo coffee roasters', 'ig': u'@vertigocoffeeroasters'},
    {'text': '#HaCoffeeBar', 'ig': u'@hacoffeebar'},
    {'text': '#Overt Denver', 'ig': u'@overt_denver'},
    {'text': '#FiddlersCoffee', 'ig': u'@fiddlerscoffee'},
    {'text': '#SirenStudiosLA', 'ig': u'@sirenstudios'},
    {'text': '#CoffeeCoffeeLA', 'ig': u'@coffeecoffeela'},
    {'text': '#OtusThaiKitchen', 'ig': u'@otus_thaikitchen'},
